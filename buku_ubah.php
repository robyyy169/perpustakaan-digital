    ...
    <div class="col-md-12">
        <form method="post">
            <?php 
              $id = $_GET['id'];
               if(isset ($_POST['submit'])) {
                ...
                if($query) {
                    echo '<script>alert("Ubah Buku Berhasi");</script>';
                }else{
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8"><input type="text" value="<?php echo $data['judul']; ?>" class="control-form" name="judul"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">Penulis </div>
                <div class="col-md-8"><input type="text" value="<?php echo $data['penulis']; ?>" class="control-form" name="penulis"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">Penerbit </div>
                <div class="col-md-8"><input type="text" value="<?php echo $data['penerbit']; ?>" class="control-form" name="penerbit"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">Tahun Terbit </div>
                <div class="col-md-8"><input type="text" value="<?php echo $data['tahun_terbit']; ?>" class="control-form" name="tahun_terbit"></div>
            </div>
            <div class="row mb-3">
