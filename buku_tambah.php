    ...
    <div class="col-md-12">
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8"><input type="text" class="control-form" name="judul"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">Penulis </div>
                <div class="col-md-8"><input type="text" class="control-form" name="penulis"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">Penerbit </div>
                <div class="col-md-8"><input type="text" class="control-form" name="penerbit"></div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">Tahun Terbit </div>
                <div class="col-md-8"><input type="text" class="control-form" name="tahun_terbit"></div>
            </div>
            <div class="row mb-3">
